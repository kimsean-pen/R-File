...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lower\_case\_letter }\OtherTok{=}\NormalTok{ letters}

\NormalTok{upper\_case\_matrix }\OtherTok{=} \FunctionTok{matrix}\NormalTok{ (LETTERS, }\AttributeTok{nrow=}\DecValTok{2}\NormalTok{, }\AttributeTok{ncol=}\DecValTok{13}\NormalTok{, }\AttributeTok{byrow =}\NormalTok{ T)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ wd1 }\OtherTok{\textless{}{-}} \FunctionTok{getwd}\NormalTok{()}
 \FunctionTok{paste}\NormalTok{(}\StringTok{"Current Working Directory: "}\NormalTok{, wd1)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## [1] "Current Working Directory:  /Users/kimseanpen/Desktop/DS_311/R-File/R_Exercise"
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Setting the working directory for a project}
\FunctionTok{setwd}\NormalTok{(}\StringTok{"/Users/kimseanpen/Desktop/DS\_311/R{-}File/R\_Exercise"}\NormalTok{)}
\NormalTok{wd2 }\OtherTok{\textless{}{-}} \FunctionTok{getwd}\NormalTok{()}
\FunctionTok{paste}\NormalTok{(}\StringTok{"Current Working Directory: "}\NormalTok{, wd2)}
\end{Highlighting}
\end{Shaded}
